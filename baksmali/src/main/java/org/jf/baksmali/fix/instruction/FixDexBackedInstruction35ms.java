...
public class FixDexBackedInstruction35ms extends DexBackedInstruction35ms {
    DexReader reader;
    public FixDexBackedInstruction35ms(DexBackedDexFile dexFile, Opcode opcode, int instructionStartOffset, DexReader reader) {
